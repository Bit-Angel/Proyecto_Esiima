...
<body>
    ...
    <main class="main">
        <a href="./calificaciones.php" class="op1">
            <img class="imag" src="./imagenes/icono_checklist.svg" alt="icono-calificaciones">
			<p class="piet">CALIFICACIONES</p>
        </a>

        <a href="./menuCarga.php" class="op2">
            <img class="imag" src="./imagenes/icono_alert.svg" alt="icono-baja">
			<p class="piet">CARGA ACADEMICA</p>
        </a>
    </main>
</body>
</html>
